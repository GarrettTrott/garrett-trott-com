...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts with topic tagging';
...
export interface ApiResumeResume extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Personal resume/CV information';
    displayName: 'Resume';
    pluralName: 'resumes';
    singularName: 'resume';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    skills: Schema.Attribute.Component<'resume.skill', true>;
...
export interface ApiTopicTopic extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Topics/tags for categorizing blog posts';
    displayName: 'Topic';
    pluralName: 'topics';
    singularName: 'topic';
  };
  ...
  attributes: {
    blog_posts: Schema.Attribute.Relation<
      ...
      'api::blog-post.blog-post'
    >;
    color: Schema.Attribute.String & Schema.Attribute.DefaultTo<'cyan'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
